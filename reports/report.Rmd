...
#### Question Responses
The question responses table has the quiz question which includes the step number. Some feature engineering  was carried out to extract the correct step number and add it to a column.
