...
To support the next iteration I have merged the Team Member, Archetype and Enrollment data sets to create separate Person and Student Info datasets, these are related on Learner_ID. Person contains details about the person including age, age_range, education level. StudentInfo contains student centric information such as enrollment dates and various roles, archetypes etc. I have also slimmed down the Step and Answers datasets. We are now left with the following structure to go into iteration 2.

![Relationships between data frames.](transformedERD.png "Transformed Entity Relationship Diagram"){width=75%}


### Iteration 2
Look at a hypotheses and repeat the steps as outlined in the introduction. Look into test results as we have a lot of data about it, relate to time in the course and leavers.
