...
```{r leaversByLastCompleteStep, echo=FALSE, out.width="100%", fig.cap="Leavers by Step of Course"}
...
You can sere that most leave the course after step 3.20 which could potentially be investigated. Further investigation the reason for leaving had multiple categories referring to the lack of time so all reasons that mentioned time were grouped as one to make it comparable with the other reasons. This is shown in Figure 4.

```{r leaversByReason, echo=FALSE, out.width="100%", fig.cap="Leavers by Reason"}
...
The other related dataset to the enrollment data is the step activity data. This indicates the stage in the course that the related data occurred at. It is principally categorical data with n=423072 items and p=7 variables, although two more were subsequently added after feature engineeering. 
...
```{r plotQuestionResponses, echo=FALSE, out.width="100%", fig.cap="Quiz Question Responses and Outcomes"}
...
Each step in the step activity data frame also has associated vidro view data. The video stats data is multivariate data with n=65 items and p=29 variables. There are significantly more data variables in this relation then in those examined previously, and significantly less data items. 
...
```{r plotVideoStats, echo=FALSE, out.width="100%", fig.cap="Video View Completions"}
...
```{r plotVideoDevice, echo=FALSE, out.width="100%", fig.cap="Video View by Device"}
  #video by device
...
```{r videoByLocation, echo=FALSE, out.width="100%", fig.cap="Video View by Location"}
  #video by location
...
```{r plotSentimentAnalysis, echo=FALSE, out.width="100%", fig.cap="Sentiment Completions"}
...
Some narrative here.
Test performance vs video views, devices or location
Leavers vs test performance
Leavers vs location
Sentiment vs Step.
