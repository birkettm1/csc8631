...
This completes iteration 1. We have imported the data, completed basic data quality checks and completed any feature engineering challenges that have presented themselves. We have also taken the identified keys and proved merging of data frames in preparation for iteration 2. Iteration 2 will deal with the construction of a hypothesis and the investigation of such.
